...
/**
 * Clase encargada de importar datos desde ficheros y añadirlos a la base de
 * datos.
 *
 * Esta clase permite importar información desde: - Ficheros TXT - Ficheros CSV
 * - Ficheros BINARIOS - Ficheros JSON
 *
 * Cada línea del fichero se convierte en un objeo y posteriormente se inserta
 * en la base de datos.
 *
 * @author Carlos
 */
public class Importar {
    ...
    // ================= IMPORTACIÓN GENERAL =================
    /**
     * Método general para importar datos desde un fichero de texto , CSV o
     * JSON.
     *
     * Funcionamiento: 1. Abre conexión con la base de datos. 2. Abre el fichero
     * indicado. 3. Lee línea por línea. 4. Procesa cada línea según la tabla.
        ...
        while ((linea = br.readLine()) != null) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(
                        null,
                        "Línea " + numLinea + " omitida (registro duplicado).",
                        "Importación",
                        JOptionPane.WARNING_MESSAGE
                );

            } catch (Exception e) {
                //Muestra el error en el panel
                JOptionPane.showMessageDialog(
                        null,
    ...
    // ================= PROCESAR UNA LÍNEA =================
    /**
     * Método encargado de convertir una línea del fichero en un objeto Java y
     * validarlo antes de insertarlo.
     *
     * Dependiendo de la tabla recibida: - Crea el objeto correspondiente -
     * Valida los datos - Inserta el objeto en la base de datos
     *
     * @param tabla:El nombre de la tabla
    ...
    // ================= BINARIO =================
    /**
     * Método encargado de importar datos desde un fichero binario (.bin).
     *
     * Funcionamiento: 1. Lee el objeto almacenado en el fichero binario. 2.
     * Recupera la lista de líneas. 3. Procesa cada línea. 4. Inserta los datos
     * en la base de datos.
     *
